...
export const loginUser = createAsyncThunk(
  "auth/loginUser",
  (credentials: { username: string; password: string }, thunkAPI) =>
    handleThunkAPI(loginUserAPI(credentials), thunkAPI)
);

export const logoutUser = createAsyncThunk("auth/logoutUser", (_, thunkAPI) =>
  handleThunkAPI(logoutUserAPI(), thunkAPI)
);
